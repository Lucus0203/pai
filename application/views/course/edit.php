					...
					<table cellspacing="0" class="comTable">
						...
						<tr>
							<th><span class="red">*</span>课程标题</th>
                                                        <td>
                                                            <span class="iptInner">
                                                            <input name="title" value="<?php echo $course['title'] ?>" type="text" class="iptH37 w345">
                                                            </span>
						...
						<tr>
							...
							<td>
                                                            <span class="iptInner">
                                                            <input name="time_start" value="<?php echo $course['time_start'] ?>" type="text" class="iptH37 w157 mr5 Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" autocomplete="off" >至<input name="time_end" value="<?php echo $course['time_end'] ?>" type="text" class="iptH37 w157 ml5 Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" autocomplete="off" >
                                                            </span>
						...
						<tr>
							...
							<td>
                                                            <span class="iptInner">
                                                            <input name="address" value="<?php echo $course['address'] ?>" type="text" class="iptH37 w345">
                                                            </span>
						...
						<tr>
							<th>培训对象</th>
							<td>
                                                            <input type="hidden" name="targetone" value="<?php echo $course['targetone'] ?>" /><input type="hidden" name="targettwo" value="<?php echo $course['targettwo'] ?>" /><input type="hidden" name="targetstudent" value="<?php echo $course['targetstudent'] ?>" />
                                                            <input readonly="true" name="target" value="<?php echo $course['target'] ?>" type="text" class="iptH37 w250"><a id="addTarget" class="borBlueH37 ml20" href="javascript:void(0)"><i class="addQuan"></i>选择名单</a>
						...
						<tr>
							...
							<td>
                                                            <span class="iptInner">
                                                            <?php  echo empty($course['page_img'])?'<a href="javascript:;" onclick="$(\'#fileBtn\').click()" class="borBlueH37 mb10">上传封面</a>':'<img onclick="$(\'#fileBtn\').click()" src="'.base_url().'uploads/course_img/'.$course['page_img'].'" width="200" />'?><input name="page_img" type="file" style="display: none;" id="fileBtn" />
<p class="gray9"><?php  echo !empty($course['page_img'])?'点击图片可更换,文件类型':'' ?>JPG、PNG、GIF格式图片，大小不超过5M</p>
                                                            </span>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
                                                            <span class="iptInner">
                                                            <input name="price" value="<?php echo $course['price'] ?>" type="text" class="iptH37 w157 mr5">元/课时
                                                            </span>
						...
						<tr>
							...
							<td>
                                                            <span class="iptInner">
                                                            <textarea name="info" class="iptare"><?php echo $course['info'] ?></textarea>
                                                            </span>
						...
						<tr>
							...
							<td>
                                                            <span class="iptInner">
                                                            <textarea name="income" class="iptare"><?php echo $course['income'] ?></textarea>
                                                            </span>
						...
						<tr>
							...
							<td>
                                                            <span class="iptInner">
                                                            <textarea name="outline" class="iptare"><?php echo $course['outline'] ?></textarea>
                                                            </span>
						...
						<tr>
							...
							<td>
                                                            <span class="iptInner">
                                                            <input type="submit" value="<?php echo empty($course)?'创建课程':'保存课程' ?>" class="coBtn mr30">
                                                                <label class="checkBox"><input name="public" <?php if($course['ispublic']=='1'){ echo 'checked="checked"';} ?> value="1" type="checkbox">发布</label>
                                                            </span>
							</td>
						</tr>
					</table>
...
<div id="conWindow" style="z-index: 99999;display:none;" class="popWinBox">
        <div class="pop_div" style="z-index: 100001;">
                <div class="title_div"><a class="closeBtn" id="popConClose" href="javascript:;">X</a><span id="title_divSpan" class="title_divText">请选择对象</span> </div>
                <div id="conMessage" class="pop_txt01">
                        <div class="secBox">
                            <ul class="oneUl">
                                    ...
                                    <li class="deparone <?php if($k==0){ echo 'secIpt';} ?>" ><label><input class="deparonecheckbox" <?php if(in_array($d['id'],$arr)){echo 'checked';} ?> type="checkbox" value="<?php echo $d['id']; ?>" /><?php echo $d['name']; ?></label></li>
                                    <?php } ?>
                                </ul>
                                ...
                                <ul class="twoUl">
                                    ...
                                    foreach ($departwo as $k=>$d){ ?>
                                        <li class="departwo <?php if($k==0){ echo 'secIpt';} ?>" ><label><input class="departwocheckbox" <?php if(in_array($d['id'],$arr)){echo 'checked';} ?> type="checkbox" value="<?php echo $d['id']; ?>" /><?php echo $d['name']; ?></label></li>
                                    <?php } ?>
                                </ul>
                                <ul class="threeUl">
                                    <?php 
                                    ...
                                    <li class="students <?php if($k==0){ echo 'secIpt';} ?>" ><label><input class="studentscheckbox" <?php if(in_array($s['id'],$arr)){echo 'checked';} ?> type="checkbox" value="<?php echo $s['id']; ?>" /><?php echo $s['name']; ?></label></li>
                                    <?php } ?>
