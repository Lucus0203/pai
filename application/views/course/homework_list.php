...
<?php if($loginInfo['role']==1||$roleInfo['homeworkedit']==1){ ?>
                                        <li><a href="<?php echo site_url('course/homeworkedit/'.$course['id']) ?>">作业编辑<i></i></a></li>
<?php } ?>
<?php if($loginInfo['role']==1||$roleInfo['homeworklist']==1){ ?>
                                        <li class="cur"><a href="<?php echo site_url('course/homeworklist/'.$course['id']) ?>">提交名单<i></i></a></li>
<?php } ?>
                                </ul>
                                ...
                                <table cellspacing="0" class="listTable">
                                        <tbody>
                                                ...
                                                <tr>
                                                        ...
                                                        <td><a href="<?php echo site_url('course/homeworkdetail/'.$h['course_id'].'/'.$h['student_id']) ?>" class="blue" target="_blank">查看作业</a></td>
                                                </tr>
                                                <?php } ?>
