...
<!--                </li>-->
                <li>
                    <a href="<?php echo site_url('index/manual') ?>" target="_blank"><i class="fa fa-file-text-o" aria-hidden="true"></i>使用手册</a>
                </li>
                <li>
            ...
            <ul class="nav nav-list">
                ...
                <li>
                    ...
                    <ul class="submenu">
                        ...
                        <li>
                            <a href="<?php echo site_url('annualplan/progress') ?>" target="backFramework"><i>&bull;</i>计划进度 </a>
                        </li>
                    </ul>
                </li>
                <li>
