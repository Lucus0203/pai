        ...
        <?php if(!empty($current_department)){ ?>
            ...
            <input type="hidden" id="current_department_name" value="<?php echo $current_department['name'] ?>" />
                <div class="texturetip clearfix"><span class="fLeft"><?php echo $current_department['name'] ?></span>
                        <div class="fRight"><?php if($current_department['level']==0){ ?><a id="addChildDepart" href="javascript:;" class="borBlueBtnH28">添加下级部门</a><?php } ?><a id="editDepart" href="javascript:;" class="borBlueBtnH28">编辑部门</a><a id="delDepart" href="javascript:;" class="borBlueBtnH28">删除部门</a><a href="<?php echo site_url('student/index/'.$current_department['id']) ?>" class="borBlueBtnH28">增加成员</a></div>
                </div>
        <?php }else{ ?>
