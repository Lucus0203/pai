...
<div class="wrap">
    <div class="textureCont nengli01">
        <div class="ttl01 aCenter">定制岗位</div>
        ...
        <div class="nengliBox mb20">
            <div class="boxl">
                <p>我们的顾问团队来自世界500强、顶尖国际咨询机构和国内领导企业。<br>1、培训派首发通用基础类岗位，具体报价见下方。<br>2、对于高端岗位定制化请咨询顾问。
                    <br> 3、岗位开通后，企业可以快速为员工树立模型。员工可开展自评与他评，找到岗位差距。
                </p>
                <p class="f18"><img src="<?php echo base_url();?>images/icon_tel.png" alt="" class="vmiddle">高端岗位定制化请咨询：<span class="blue">021-61723727</span></p>
            </div>
